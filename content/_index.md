...
sections:
  - type: hero_section
    title: HarlonTransit
    subtitle: Keeping you moving
    content: >-
      HarlonTransit is the government-owned transport operator around Harlon. 
    actions:
      - label: Trip Planner
        url: /pricing
        style: primary
      - label: Route Map
        url: https://drive.google.com/file/d/1wlTEnaUhLJ9O9UL-uGLn0Gzf1632INLf/view?usp=sharing
        style: secondary
    image: images/ht-train.png
    image_alt: HarlonTransit Metro train
    media_position: left
    media_width: fifty
    align: left
    padding_top: large
  ...
  - type: features_section
    features:
      - title: Go2 Card
        subtitle: Your ticket to Harlon's public transport
        content: >-
          The Go2 Card, a reloadable smartcard, is the ticket for travel on all modes of public transport in Harlon. The Card is sold and can be reloaded at ticket machines at all Metro and Commuter train stations, and major transit interchanges.
        actions:
        ...
        media_position: left
        media_width: fifty
      - title: Mainline services
        subtitle: Coming soon
        content: >-
          Mainline services are not operational yet, and are dependent on the opening of additional towns and cities on the server.
        actions:
          - label: Take a look
            url: /pricing
            style: secondary
    ...
    background_color: none
  - type: cta_section
    title: Plan your trip with HarlonTransit now!
    content: >-
      Use our interactive Trip Planner, or keep a copy of our official route map handy.
    actions:
      - label: Trip Planner
        url: /pricing
        style: primary
      - label: Route Map
        url: https://drive.google.com/file/d/15ToA12fJS86jU-Q7-8jJXVYw2ZyufvxX/view
        style: secondary
        has_icon: false
        icon: arrow-left
        icon_position: right
